...
class RenameColumnFamilyOnTriggerInsertOnBmsProducts extends Migration
{
    /**
     * Run the migrations.
     *
        ...
        DB::unprepared('
            ...
            BEGIN
                INSERT INTO bms_products (
                    name, avg_price, last_price, sell_unit, current_stock, stock_mov, category_code, sub_category_code, pvp_1, pvp_2, pvp_3, pvp_4, pvp_5, pvp_6, erp_product_id, primavera_table_id, iva, created_at, updated_at)
