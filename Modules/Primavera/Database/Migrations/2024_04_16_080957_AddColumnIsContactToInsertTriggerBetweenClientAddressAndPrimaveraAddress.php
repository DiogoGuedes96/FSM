...
class AddColumnIsContactToInsertTriggerBetweenClientAddressAndPrimaveraAddress extends Migration
{
    public function up()
    {
        DB::unprepared('DROP TRIGGER IF EXISTS client_address_primavera_address_after_insert_update_trigger');
        DB::unprepared('
            CREATE TRIGGER client_address_primavera_address_after_insert_update_trigger
            AFTER INSERT ON primavera_address 
            FOR EACH ROW
            BEGIN
